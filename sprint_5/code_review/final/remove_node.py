...
Глубина стека рекурсивной функции поиска элемента для удаления так же зависит от количества вершин и сбалансированности дерева.
Может быть O(H), если дерево сбалансировано и O(n), если н есбалансировано.
Итого может понадобится либо O(H) либо O(n) доп памяти в худшем случае.
"""
